    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-foreground mt-2">{adminSystemStats.activeSupervisors}</p>
          <p className="text-xs text-success mt-2">Supervisors online</p>
        </div>

        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <p className="text-foreground-secondary text-sm font-medium">Data Processed</p>
          <p className="text-3xl font-bold text-foreground mt-2">12.4 GB</p>
          <p className="text-xs text-success mt-2">Last 24 hours</p>
        </div>

        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <p className="text-foreground-secondary text-sm font-medium">Avg Response Time</p>
