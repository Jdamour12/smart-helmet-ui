        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-foreground-secondary font-medium">No supervisors yet</p>
              <p className="text-foreground-tertiary text-sm mt-1">Add your first supervisor to get started</p>
            </div>
          ) : (
