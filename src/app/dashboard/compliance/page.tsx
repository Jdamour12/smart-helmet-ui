...
export default function ComplianceReports() {
  ...
  const complianceRate = Math.round((helmetWearingCount / mockHelmets.length) * 100);
  const nonComplianceCount = mockHelmets.filter(h => !h.helmetWear).length;
  const avgComplianceRate = complianceData.reduce((sum, d) => sum + d.value, 0) / complianceData.length;
        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-foreground-tertiary mt-2">{helmetWearingCount} of {mockHelmets.length}</p>
            </div>
        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-foreground mt-2">{avgComplianceRate.toFixed(0)}%</p>
        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-warning mt-2">{nonComplianceCount}</p>
        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-foreground mt-2">{(95 - complianceRate).toFixed(0)}%</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border/50">
                  ...
                  <th className="px-4 py-3 text-left text-foreground-secondary text-sm font-semibold">Action</th>
                </tr>
              </thead>
              <tbody>
