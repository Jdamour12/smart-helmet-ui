    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <p className="text-foreground-secondary text-sm">Current Compliance Rate</p>
          <p className="text-3xl font-bold text-success mt-2">{complianceRate}%</p>
          <p className="text-xs text-foreground-tertiary mt-2">{helmetWearingCount} of {mockHelmets.length} workers</p>
        </div>
        <div className="bg-background-secondary border border-border rounded-lg p-6">
        ...
        <div className="bg-background-secondary border border-border rounded-lg p-6">
          <p className="text-foreground-secondary text-sm">Non-Compliance Events</p>
          <p className="text-3xl font-bold text-warning mt-2">{mockHelmets.filter(h => !h.helmetWear).length}</p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-foreground text-sm font-medium">{mockHelmets.length}/6</span>
            </div>
          </div>
          <div>
          ...
          <div>
            <p className="text-foreground-secondary text-sm mb-2">Safety Alert Compliance</p>
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-background rounded-full h-2">
