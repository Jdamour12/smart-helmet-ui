...
import { Menu, Shield, Bell, User, Settings, HelpCircle, LogOut } from 'lucide-react';
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="w-9 h-9 bg-critical rounded-full flex items-center justify-center hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-critical/40">
              <span className="text-sm font-bold text-white select-none">AU</span>
            </button>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            align="end"
          ...
          >
            <div className="px-3 py-3">
              ...
              <p className="text-xs text-foreground-tertiary mt-0.5">admin@safehelm.io</p>
            </div>
            <DropdownMenuSeparator />
